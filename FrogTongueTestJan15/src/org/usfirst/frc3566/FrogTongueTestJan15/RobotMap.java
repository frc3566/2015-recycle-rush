...
public class RobotMap {
    ...
    public static SpeedController frogtongueSpeedController4;
    public static RobotDrive frogtongueFrogTongueDrive43;
    ...
    public static void init() {
        ...
        frogtongueSpeedController4 = new Talon(4);
        LiveWindow.addActuator("Frogtongue", "Speed Controller 4", (Talon) frogtongueSpeedController4);
        
        frogtongueFrogTongueDrive43 = new RobotDrive(frogtongueSpeedController4, frogtongueSpeedController3);
        
        frogtongueFrogTongueDrive43.setSafetyEnabled(true);
        frogtongueFrogTongueDrive43.setExpiration(0.1);
        frogtongueFrogTongueDrive43.setSensitivity(0.5);
        frogtongueFrogTongueDrive43.setMaxOutput(1.0);

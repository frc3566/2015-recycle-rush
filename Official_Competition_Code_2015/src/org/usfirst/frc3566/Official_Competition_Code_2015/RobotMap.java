...
public class RobotMap {
	public static CANTalon mecanumCAN_Talon_3; //FronTRight
    public static CANTalon mecanumCAN_Talon_4; //FrontLeft
    public static CANTalon mecanumCAN_Talon_5; //RearLeft
    ...
    public static void init() {
        ...
        mecanumMecanum_Control = new RobotDrive(mecanumCAN_Talon_4, mecanumCAN_Talon_5, mecanumCAN_Talon_3, mecanumCAN_Talon_2);

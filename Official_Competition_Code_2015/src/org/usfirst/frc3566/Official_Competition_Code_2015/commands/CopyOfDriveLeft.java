 ...
 *
 */
public class  CopyOfDriveLeft extends Command {
	double initialAngle;
	double timeout;
	double currentAngle;
    double diffAngle;
    
    public CopyOfDriveLeft() {
    	this(10);
    }
   
    public CopyOfDriveLeft(double timeout) {
        // Use requires() here to declare subsystem dependencies
        // eg. requires(chassis);
    	this.timeout = timeout;
        // BEGIN AUTOGENERATED xCODE, SOURCE=ROBOTBUILDER ID=REQUIRES
    ...
    protected void execute() {
    	...
    	RobotMap.mecanumMecanum_Control.mecanumDrive_Polar(1, 265, -(diffAngle*0.03));
    }

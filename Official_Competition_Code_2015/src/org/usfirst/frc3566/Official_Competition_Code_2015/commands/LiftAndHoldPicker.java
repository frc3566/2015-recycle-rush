 ...
 *
 */
public class  LiftAndHoldPicker extends Command {

    public LiftAndHoldPicker() {
    ...
    protected boolean isFinished() {
        return Robot.containerPicker.getPickerPotentiometer() == Robot.containerPicker.HOLD_POINT;
    }
